package manager.cluster.service.impl;

import com.baidu.brpc.client.BrpcProxy;
import com.baidu.brpc.client.RpcClient;
import com.baidu.brpc.client.RpcClientOptions;
import com.baidu.brpc.client.instance.Endpoint;
import manager.core.raftimpl.raft.Peer;
...
public class ClusterServiceImpl implements ExampleService {
    ...
    public ClusterServiceImpl(RaftNode raftNode, StateMachine stateMachine) {
    ...
    public ClusterProto.SetResponse set(ClusterProto.SetRequest request) {
        ...
        if (raftNode.getLeaderId() <= 0) {
            ...
            onLeaderChangeEvent();
            ClusterProto.SetResponse responseFromLeader = leaderService.set(request);
