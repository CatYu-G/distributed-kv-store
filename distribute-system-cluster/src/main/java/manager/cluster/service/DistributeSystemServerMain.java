...
import manager.core.raftimpl.raft.RaftNode;
import manager.core.raftimpl.raft.RaftOptions;
import manager.core.raftimpl.raft.StateMachine;
import manager.cluster.machine.LevelDBStateMachine;
import manager.cluster.service.impl.ClusterServiceImpl;
import manager.core.raftimpl.raft.proto.RaftProto;
import manager.core.raftimpl.raft.service.RaftClientService;
import manager.core.raftimpl.raft.service.RaftConsensusService;
import manager.core.raftimpl.raft.service.impl.RaftClientServiceImpl;
import manager.core.raftimpl.raft.service.impl.RaftConsensusServiceImpl;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by raftimpl on 2024/5/9.
 */
public class DistributeSystemServerMain {
...
//                new BitCaskStateMachine(raftOptions.getDataDir());
        ...
        // 注册应用自己提供的服务
        ExampleService exampleService = new ClusterServiceImpl(raftNode, stateMachine);
