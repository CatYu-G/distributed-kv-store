...
public class RaftClusterServiceProxy implements RaftClientService {
    private static final Logger LOG = LoggerFactory.getLogger(RaftClusterServiceProxy.class);
    ...
    public RaftClusterServiceProxy(String ipPorts) {
